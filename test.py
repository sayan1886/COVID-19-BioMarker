...
from utils import constants, preprocess
...
# RFClassifier/ XGBoostClassifier directly returns probability for class 1 by default 
def prob(data):
...
lassoreg.fit(X_resampled_train,y_resampled_train)
...
# Train a XGBoost Classifier using the selected features 
